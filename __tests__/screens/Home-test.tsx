...
import { APIRequest, BASE_URL } from '../../app/controller/api/api';

import axiosMock from '../__mock__/axios';
import axios from 'axios';
import {it, describe, expect, beforeEach, test, jest} from '@jest/globals';
...
describe('HomeScreen', () => {
    ...
    it('Should navigate to details page', () => {
        ...
        expect(mocks.navigation.navigate).toBeCalledWith('Login');
    });
    ...
    describe('Testing API', () => {
        ...
        test('should display how async / await works with reject', async () => {
            const err = Promise.reject('something went');
            const err1 = Promise.resolve('something went');


            console.log('err', err)

            err1.then(err => {
            console.log('err123', err1)

                expect(err).toBe('something went');
            })
            err.catch(err => {
